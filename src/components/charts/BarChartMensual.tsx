...
export function BarChartMensual({
  data, nombreSegunda = "Delivery",
}: {
  data: { mes: string; reservas: number; pedidos: number }[]; nombreSegunda?: string;
}) {
  return (
    <ResponsiveContainer width="100%" height={220}>
      <BarChart data={data} barGap={4}>
        ...
        <Bar dataKey="pedidos" name={nombreSegunda} fill="#E08A3E" radius={[6, 6, 0, 0]} maxBarSize={22} />
      </BarChart>
    </ResponsiveContainer>
  );
}
