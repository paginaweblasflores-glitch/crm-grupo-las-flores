...
// (mesDia = "MM-DD"); las que se mueven de fecha real (Carnavales, Semana
// Santa) quedan con una fecha aproximada, editable desde el sistema.
export const FESTIVIDADES: Festividad[] = [
  { id: "fest-anio-nuevo", nombre: "Año Nuevo", mesDia: "01-01", tipo: "civico", alcance: "todas" },
  { id: "fest-carnavales", nombre: "Carnavales", mesDia: "02-14", tipo: "comercial", alcance: "todas", descripcion: "Fecha aproximada — se mueve cada año." },
  ...
  { id: "fest-aniversario-flores", nombre: "Aniversario Restaurante Las Flores", mesDia: "03-15", tipo: "comercial", alcance: ["las-flores"] },
  { id: "fest-aniversario-umaru", nombre: "Aniversario Hotel Umaru", mesDia: "09-10", tipo: "comercial", alcance: ["umaru"] },
